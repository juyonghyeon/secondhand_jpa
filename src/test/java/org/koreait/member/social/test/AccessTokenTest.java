...
public class AccessTokenTest {
    ...
    void test() {
        ...
        body.add("client_id", "c858d489f854551908c3038c2f174e0a");
        body.add("redirect_uri", "http://localhost:3000/member/social/callback/kakao");
        body.add("code", "gO3ve-1f9O61MjR3ekq5RcIDWj91PbKCJspOQBLl1N4nsuDJMNj4fgAAAAQKFwAnAAABmBusx0aGtS2__sNdBQ");
